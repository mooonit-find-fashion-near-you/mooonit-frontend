  ...
  return (
    ...
    >
      ...
      <div className="relative h-60 overflow-hidden rounded-t-2xl rounded-b-4xl">
        ...
        {/* Certified Badge */}
        <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm rounded-full px-4 pl-2.5 py-1.5 flex items-center gap-2">
          {/* Star-like Certified SVG */}
          <svg
            width="20"
            height="20"
            viewBox="0 0 26 27"
          ...
          >
            <path
              d="M25.3448 14.7732L23.5565 12.5553L24.872 10.0678L22.5045 8.66142L22.873 5.84864L20.1384 5.41607L19.4542 2.65762L16.7717 3.30683L15.1941 0.980957L12.8794 2.54965L10.5655 0.980957L8.98714 3.30683L6.30466 2.65762L5.62118 5.41607L2.88586 5.84864L3.25437 8.66142L0.887562 10.0678L2.20238 12.5553L0.414062 14.7732L2.57088 16.6122L1.67673 19.3163L4.30636 20.2357L4.46419 23.1029L7.19882 22.9942L8.35649 25.5903L10.8804 24.4549L12.8794 26.4562L14.8784 24.4549L17.4031 25.5903L18.5601 22.9942L21.2954 23.1029L21.4532 20.2357L24.0828 19.3163L23.1887 16.6122L25.3448 14.7732Z"
              fill="#EA9C00"
            />
            <path
              d="M12.8799 22.6163C17.6731 22.6163 21.5587 18.6206 21.5587 13.6917C21.5587 8.76281 17.6731 4.76715 12.8799 4.76715C8.08678 4.76715 4.20117 8.76281 4.20117 13.6917C4.20117 18.6206 8.08678 22.6163 12.8799 22.6163Z"
              fill="#FFBEB9"
            />
            <path
              d="M11.3525 17.964L7.67091 14.1781C7.3024 13.7992 7.3024 13.2043 7.67091 12.8261C8.03942 12.4479 8.61791 12.4471 8.98573 12.8261L11.4054 15.3143L16.8225 9.74374C17.191 9.3648 17.7695 9.3648 18.1373 9.74374C18.5058 10.1227 18.5058 10.7176 18.1373 11.0958L11.3519 17.9647L11.3525 17.964Z"
              fill="#F7F7F7"
            />
          </svg>

          <span className="text-[#808080] text-sm font-medium">Certified</span>
        </div>

        {/* Dark underlay */}
        <div className="absolute bottom-0 left-0 right-0 h-1/2 bg-gradient-to-t from-[#2c2d3a]"></div>
        ...
        <div className="absolute bottom-8 right-4 bg-[#ffdc91] rounded-full px-3 py-1.5 flex items-center gap-1">
          ...
          <span className="text-[#2c2d3a] text-sm font-medium">
            {shop.rating}
          </span>
        </div>
          ...
          <div className="flex items-center gap-1 text-sm">
            ...
            >
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M17.7063 0.590088C18.6617 0.239561 19.585 1.18109 19.2413 2.15421L13.2054 19.2495C12.8306 20.3123 11.3646 20.3327 10.9609 19.2801L8.13385 11.915L0.91078 9.0333C-0.120516 8.62164 -0.10053 7.1268 0.94076 6.74367L17.7063 0.589069V0.590088Z"
                fill="#4285F4"
              />
            </svg>
